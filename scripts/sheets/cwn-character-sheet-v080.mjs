...
export function createCwnCharacterSheetClass(SWNActorSheet) {
  return class CwnCharacterSheet extends SWNActorSheet {
    ...
    static PARTS = {
      header: { template: `modules/${MODULE_ID}/templates/sheets/character/header-v080.hbs` },
      combat: { template: `modules/${MODULE_ID}/templates/sheets/character/combat-v064.hbs` },
      skills: { template: `modules/${MODULE_ID}/templates/sheets/character/skills-v062.hbs` },
      inventory: { template: `modules/${MODULE_ID}/templates/sheets/character/inventory-v080.hbs` },
      cyberware: { template: `modules/${MODULE_ID}/templates/sheets/character/cyberware-v062.hbs` },
      features: { template: `modules/${MODULE_ID}/templates/sheets/character/features-v080.hbs` },
