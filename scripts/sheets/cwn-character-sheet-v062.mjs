...
export function createCwnCharacterSheetClass(SWNActorSheet) {
  return class CwnCharacterSheet extends SWNActorSheet {
    ...
    static PARTS = {
      ...
      combat: { template: `modules/${MODULE_ID}/templates/sheets/character/combat-v062.hbs` },
      ...
      actions: { template: `modules/${MODULE_ID}/templates/sheets/character/actions-v062.hbs` },
