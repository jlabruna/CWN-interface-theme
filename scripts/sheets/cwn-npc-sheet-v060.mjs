...
export function createCwnNpcSheetClass(SWNActorSheet) {
  return class CwnNpcSheet extends SWNActorSheet {
    ...
    static PARTS = {
      header: { template: `modules/${MODULE_ID}/templates/sheets/npc/header-v060.hbs` },
      combat: { template: `modules/${MODULE_ID}/templates/sheets/npc/combat-v060.hbs` },
      ...
      biography: { template: `modules/${MODULE_ID}/templates/sheets/npc/biography-v060.hbs` },
