...
export function createCwnNpcSheetClass(SWNActorSheet) {
  return class CwnNpcSheet extends SWNActorSheet {
    ...
    static PARTS = {
      header: { template: `modules/${MODULE_ID}/templates/sheets/npc/header-v061.hbs` },
      combat: { template: `modules/${MODULE_ID}/templates/sheets/npc/combat-v061.hbs` },
      ...
      biography: { template: `modules/${MODULE_ID}/templates/sheets/npc/biography-v061.hbs` },
