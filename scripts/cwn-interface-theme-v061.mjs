import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v061.mjs?v=0.6.1";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v061.mjs?v=0.6.1";
