import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.7.0";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v064.mjs?v=0.7.0";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v070.mjs?v=0.7.0";
