import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.6.4";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v064.mjs?v=0.6.4";
