import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v060.mjs?v=0.6.0";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v060.mjs?v=0.6.0";
