import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.9.1";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v091.mjs?v=0.9.1";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v073.mjs?v=0.9.1";
