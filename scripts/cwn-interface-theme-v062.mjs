import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.6.2";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v062.mjs?v=0.6.2";
