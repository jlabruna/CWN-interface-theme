import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.9.0";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v090.mjs?v=0.9.0";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v073.mjs?v=0.9.0";
