import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.10.0";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v091.mjs?v=0.10.0";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v0100.mjs?v=0.10.0";
import { registerCwnCyberdeckSheet } from "./sheets/cwn-cyberdeck-sheet-v0100.mjs?v=0.10.0";
