import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.6.3";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v063.mjs?v=0.6.3";
