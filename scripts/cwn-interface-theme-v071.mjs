import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.7.1";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v064.mjs?v=0.7.1";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v071.mjs?v=0.7.1";
