import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.8.2";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v082.mjs?v=0.8.2";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v073.mjs?v=0.8.2";
