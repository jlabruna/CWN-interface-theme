import { registerCwnNpcSheet } from "./sheets/cwn-npc-sheet-v062.mjs?v=0.9.2";
import { registerCwnCharacterSheet } from "./sheets/cwn-character-sheet-v091.mjs?v=0.9.2";
import { registerCwnDroneSheet } from "./sheets/cwn-drone-sheet-v092.mjs?v=0.9.2";
