...
const browserDotfilesRoot = path.join(releaseRoot, "github-dotfiles-upload-v0.12.1");
const browserWorkflowRoot = path.join(releaseRoot, "github-workflow-v0.12.1");
...
const browserReleaseFiles = [
  ...
  "package.json",
  "lang/en.json",
  "scripts/cwn-interface-theme-v0121.mjs",
