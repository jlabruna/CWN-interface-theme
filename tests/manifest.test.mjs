...
test("manifest targets Foundry V14 and SWNR 2.3.1", () => {
  ...
  assert.deepEqual(manifest.esmodules, ["scripts/cwn-interface-theme-v0121.mjs"]);
  assert.deepEqual(manifest.styles, ["styles/cwn-interface-theme-v0101.css", "styles/cwn-interface-theme-v0121.css"]);
});
